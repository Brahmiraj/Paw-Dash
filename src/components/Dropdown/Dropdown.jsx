...
const Dropdown = ({DropdownText, DropdownImg}) => {
  return (
      <div className="max-sm:text-xs max-sm:px-2 flex justify-center items-center ring-1 ring-white p-3 rounded-xl gap-5 max-sm:gap-0 max-sm:p-1 hover:bg-[#064986]">
