...
const Infocard = ({contant1, contant2, contant3}) => {
  return (
    ...
    <div className='flex justify-between gap-5 max-xl:text-xs special:text-3xl'><h1>{contant1}</h1><img src={infoImg} alt="infoImg" className='special:w-8 cursor-pointer'/></div>
